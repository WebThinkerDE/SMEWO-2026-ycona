<?php
/**
 * Cart Page – Floorplan theme override
 *
 * Custom template based on WooCommerce cart.php. All WooCommerce hooks and
 * functionality are preserved; layout and markup are themed for Floorplan.
 *
...
<div class="wt-shop-cart-wrap">
	<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
		<?php do_action( 'woocommerce_before_cart_table' ); ?>

        <div class="d-flex flex-column flex-lg-row gap-5">
            <div class="col-12 col-lg-8">
                <div class="wt-shop-cart-table-scroll">
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="cart-actions-row mt-5">
                    <h3 class="mb-3"><?php esc_html_e( 'Coupon Code', 'woocommerce' ); ?></h3>
                    ...
                    <button type="submit" class="mt-3 button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
