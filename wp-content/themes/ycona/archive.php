                    ...
                    <?php while ( have_posts() ) : the_post();
                        ...
                        <li class="hex">
                                ...
                                <div class="hex-in">
                                    ...
                                    <h2 class="wt-h3"><?php the_title(); ?></h2>

                                        <p class="hex-in-description">
                                            <?php echo wp_trim_words( get_the_excerpt(), 18, '...' ); ?>
                                        </p>

                                        <span class="hex-btn"><?php echo __( 'Lire la suite', 'ycona' ); ?></span>
                                    </a>
                                </div>
