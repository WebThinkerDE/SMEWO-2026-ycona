(function (blocks, element, blockEditor, components, data) {
    ...
    registerBlockType('wt/you-may-like-block', {
        apiVersion: 3,
        title: 'You may also like',
        icon: 'products',
        category: 'wt-shop-blocks',
        description: 'Product slider – same design as single product / 404. Show random products or choose specific ones.',
        example: {},
        attributes: {
            layout: { type: 'string' },
        ...
        edit: withSelect(function (select) {
            ...
            return el(Fragment, null,
                ...
                el('div', useBlockProps( {
                    id: 'you-may-like-block',
                    className: 'webthiker-block worker-block wt-you-may-like-block-editor'
                } ),
                    el('h3', null, 'You may also like'),
                    el('dl', null,
